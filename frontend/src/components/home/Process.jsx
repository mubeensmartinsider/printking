...
const STEP_ICONS = {
  "01": ClipboardList, "02": PenTool, "03": FileCheck, "04": Printer,
  "05": Package, "06": Truck, "07": HeartHandshake,
};
      ...
      <div className="section-pad relative mx-auto max-w-[1400px]">
        ...
        <div className="relative hidden md:block">
          <svg className="absolute left-0 top-[14px] h-6 w-full" preserveAspectRatio="none" viewBox="0 0 1000 20">
            <line x1="0" y1="10" x2="1000" y2="10" stroke="var(--color-border)" strokeWidth="1" />
        ...
        <div className="relative space-y-8 border-l border-border-soft pl-8 md:hidden">
          {PROCESS.map((step) => {
