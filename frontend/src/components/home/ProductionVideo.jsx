    ...
    <section data-testid="video-section" className="relative bg-carbon py-28">
      <div className="section-pad mx-auto max-w-[1400px]">
        ...
        <div
          ...
          style={{ boxShadow: "0 0 80px rgba(201,168,76,0.12)" }}
        >
          ...
          <div className="absolute inset-0 bg-[#0d0f1e]">
            ...
            <div className="absolute inset-0" style={{ background: "radial-gradient(80% 60% at 50% 40%, rgba(201,168,76,0.10), transparent 65%)" }} />
          </div>
          {/* Letterbox gradients */}
          <div className="pointer-events-none absolute inset-x-0 top-0 h-24" style={{ background: "linear-gradient(#07080fcc, transparent)" }} />
          <div className="pointer-events-none absolute inset-x-0 bottom-0 h-24" style={{ background: "linear-gradient(transparent, #07080fcc)" }} />
