  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      if (ringRef.current) {
        ...
        ringRef.current.style.borderColor = hovering ? "rgba(201,168,76,0.9)" : "rgba(201,168,76,0.5)";
        ringRef.current.style.backgroundColor = hovering ? "rgba(201,168,76,0.10)" : "transparent";
      }
